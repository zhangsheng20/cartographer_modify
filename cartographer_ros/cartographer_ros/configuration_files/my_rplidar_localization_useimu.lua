...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians=math.rad(180/TRAJECTORY_BUILDER_2D.submaps.num_range_data/POSE_GRAPH.optimize_every_n_nodes)
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.translation_weight = 1e3 --10
...
POSE_GRAPH.matcher_rotation_weight=1e1  -- 5e2
POSE_GRAPH.optimization_problem.rotation_weight=3e8  --3e5
POSE_GRAPH.optimization_problem.acceleration_weight=1e1   --1e3
